...
--
-- v7.64: "Log/ Fabr" (fábrica) SÍ genera OC (pedido del usuario). "Racks" (importación)
...
begin
  ...
  calc as (
    select n.cod, n.descripcion, n.proveedor, n.uni_caja, nc.n_caja,
     ...
     where upper(n.proveedor) not in ('RACKS', 'RACK')   -- v7.64: Racks afuera; Log/Fabr SÍ genera
