...
--    Se guarda acá porque el repo `pagina-LK-copia` no está adjunto a la sesión. **Hay que
--    copiarlo al repo de LK.** Mismo caso que `sql/lk_reporte_hoy_plata_v1424.sql`.
--
-- EL PROBLEMA
-- ===========
