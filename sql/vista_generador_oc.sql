...
--
-- A pedir = max(0, ceil(maximo + pedidos - stock)).
--
-- v9.65 (dueño) — STOCK = TODO el módulo Stocks (los 8 depósitos, igual que la columna
-- "Total Stock"): terminado + a_guardar + racks + excedente + separar_pedidos + a_facturar
