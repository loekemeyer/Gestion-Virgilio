-- =============================================================================
-- v14.11 (2026-09-07) — Cruce Facturación ↔ ISIS: asignación 1-a-1 de facturas
--
...
comment on function public.gv_cruce_fc_asignacion() is
  'v14.11 — Asigna cada factura de ISIS a UNA sola NP (greedy por diferencia de cajas y fecha). La usa gv_vista_cruce_facturacion.';
...
comment on view public.gv_vista_cruce_facturacion is
  'v14.11 — Cruza el neto que calculó Gestión contra la factura real de ISIS. Cada factura se asigna a una sola NP (gv_cruce_fc_asignacion). El estado ambiguo ya no existe.';
