-- v21.14 (Luis, 2026-09-22) - DE DONDE VIENE EL REGISTRO DE UNA TANDA QUE LO HEREDO
--
...
comment on view public.gv_tanda_registro_heredado is
  'v21.14 - Tandas que recibieron el registro de un pedido ya armado (v21.10). Una fila por '
