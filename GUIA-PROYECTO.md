...
>
> Nota: **v7.49 — Visualizador de OCs: se alimenta de la RECEPCIÓN + impreso con el formato de la
...
> compartido, override manual). Bump **v7.49** (`APP_VERSION` + `SW_VERSION` `v7.49-vir`).
>
