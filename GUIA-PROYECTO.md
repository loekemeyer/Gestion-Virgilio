...
>
> Última actualización: 2026-07-30 · Versión app al documentar: **v6.48**
>
...
condición en la vista, no un movimiento. Las leen el botón **"⬇ Exportar Excel"** de
la PPP (`pppExportExcel`) y el Apps Script `apps-script/ppp-a-excel.gs` (.xlsx en
Drive auto-refrescado). Auditadas por auditor-supabase (aprobadas).
