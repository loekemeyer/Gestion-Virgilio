...
function pendCard(r) {
  ...
  const foot = document.createElement("div"); foot.className = "pcFoot";
  /* v9.60 — el código lo genera opEnviar() AL CREAR la fila (v8.83), para que el operario
...
async function pendEnviar(id, foot) {
  ...
  try {
    /* v9.60 — REUSAR el código que la fila ya trae (el que el operario escribió en el remito
