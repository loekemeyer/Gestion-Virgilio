...
echo "== feriados-canonica (v21.46: los dos fronts bajan public.GV_Feriados y conservan su fallback) =="
node tests/feriados-canonica.cjs

echo "== mon-vs-vista (v21.46: 7 numeros, hs_prod incluido: el monitor grande y la vista de la TV dan el MISMO numero) =="
