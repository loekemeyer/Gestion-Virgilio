...
echo "== ocg-depurar (v7.55: depurar incompletos + parámetros de proyección (período/suavizar)) =="
PLAYWRIGHT_BROWSERS_PATH="${PLAYWRIGHT_BROWSERS_PATH:-/opt/pw-browsers}" node tests/ocg-depurar.cjs
