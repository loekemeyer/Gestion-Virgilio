...
echo "== ins-categorias (idea 7917 / v7.24: navegación + alta por categorías en RI/EI) =="
...
echo "== ins-admin (idea 5572 / v7.24: Administrar Insumos (pendientes + categorías + unidades)) =="
