...
echo "== ins-categorias (idea 7917 / v7.22: navegación + alta por categorías en RI/EI) =="
...
echo "== ins-admin (idea 5572 / v7.22: Administrar Insumos (pendientes + categorías + unidades)) =="
