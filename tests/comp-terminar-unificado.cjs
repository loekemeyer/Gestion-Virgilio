/* Unificación v7.75 — el botón "Terminar" del asistente Completar ahora emite TAP
   ...
   - v18.00: se pregunta la ubicación de cada NP (AUB) ANTES de escribir, y se emite el AUB.
   Sale 1 si falla. */
...
(async () => {
  ...
  const r = await p.evaluate(async () => {
    ...
    // v18.00 — compTerminar ahora pregunta la UBICACIÓN de cada NP (evento AUB) antes de
    ...
    // v18.00 — la ubicación se pregunta ANTES del primer write (líos), y el AUB sale con el TAP.
