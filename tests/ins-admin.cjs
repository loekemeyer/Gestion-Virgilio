...
(async () => {
  ...
  const r = await p.evaluate(async () => {
    ...
    // idea 8628: los botones Guardar/Cancelar/unidad de la fila en edición van en un contenedor
    // nowrap (no se apilan en 2-3 líneas y agrandan la fila en mobile). Hoy son 3 botones.
    ...
    out.totalEditBtnsNowrap = !!_accCell5 && /white-space:\s*nowrap/.test(_accCell5.innerHTML) && _accCell5.querySelectorAll("button").length >= 2 && !!_accCell5.querySelector("div");
