...
### v14.67 (2026-09-10) — Guarda anti-doble-generación de OCs + limpieza de duplicados
...
-- 3) revertir el front: ocgGenerar vuelve al POST a SUPABASE_OC_ENDPOINT (commit v14.67).
-- backup table: drop table public."GV_Backup_OC_dup_20260909";  -- recién cuando esté OK
```
SQL fuente: `sql/gv_oc_generar_pendientes_v1467.sql`.
