...
- [ ] **9020** (2026-08-01) — **Resolver la empresa por el número de NP** (`9…` = Loekemeyer, `4…` = Chef) + **empresa por sector en la planimetría**. Cuando una NP pide un código que existe en las dos empresas (ej. `438E`), que descuente del stock de la empresa que indica el prefijo de la NP y que el picking muestre el sector de **esa** empresa. Verificado: las 947 NPs empiezan con 4 (143) o con 9 (804), sin excepciones, y el cruce por artículo da 100% consistente. Reemplaza las equivalencias **fijas** de la idea 3197, que aciertan la mayoría pero fallan en la minoría (71 cajas de `809E` pedidas por NPs de Loekemeyer son Corta Pizza Familiar, no Corta Queso) — _pendiente_
