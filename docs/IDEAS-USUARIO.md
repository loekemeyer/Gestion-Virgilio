...
- [x] **5290** (2026-07-31, hecho 2026-08-01 v6.88) — **Impresora automática de etiquetas por lío**. El **programa emite solo** cada etiqueta al terminar el armado. Ej: 10 líos → **10 etiquetas**, cada una con **composición (cod+cajas) + razón social abreviada** (tanda/NP/operario; lugar de entrega ⏳ pendiente de parametrizar). — _hecho (v6.88, **piloto** detrás del switch `vir_etiqueta_lio` + sólo legajo 0/1): al terminar el armado la app encola en `Etiquetas_Lio` (Supabase) una etiqueta por lío con su ZPL; el imprimidor `tools/imprimir-etiquetas-lio.ps1` (PowerShell, RAW) corre en la PC de la **Zebra S4M** y las saca solas. ⏳ Falta: sumar el lugar de entrega + probar con la impresora real; después ampliar a legajos reales y (a futuro) micro-PC + impresora por puesto._
