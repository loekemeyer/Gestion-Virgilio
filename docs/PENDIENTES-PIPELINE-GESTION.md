...
| ~~**Prender la numeración**~~ | ✅ **PRENDIDA el 2026-09-04 a la noche, sólo del lado Virgilio** (decisión del dueño: no tocar Producción ni LK). `numeracion_activa = 1`, cron 71 activo, prefijo `GV-` se mantiene, borradores de prueba borrados con backup. Antes se arregló el agujero de v12.88 (**pendiente = no enviado a compras**: el job habría programado 208 pedidos ya entregados por ISIS). Verificado en transacción revertida: asigna `LK 00001`, `LK 00002`; `PPP_Web_NP` sigue en 0. ⚠ El mail de las 12:30 en LK **sigue andando**: lo que Gestión programe a la mañana ISIS lo manda igual al mediodía; se resuelve apagando `procesar-pedidos-web` el día del cambio real. Detalle §3.l | hecho |
