...
async function trySendOneReport(payload) {
  try {
    ...
    const isUpsert = (payload.opcion === "FJ" || payload.opcion === "PKC" || payload.opcion === "CCN" || payload.opcion === "PSP" || payload.opcion === "CRN" || payload.opcion === "CRA");
    const url    = isUpsert
