...
>
> Es el `CLAUDE.md` del repo **`GestionProductivaEntero`**, traído tal cual el 2026-09-10 cuando ese admin
> se copió acá adentro (`cervantes-admin/entero/`). Se guarda **renombrado a propósito**: un archivo
