...
### ⚠ De dónde heredó el registro una tanda: `gv_tanda_registro_heredado` (v21.15, Luis)
...
**Chequeo:** `select * from public.gv_reglas_perdidas;` — vacía = todo bien.
`sql/gv_pedido_mover_registro_v2105.sql`, `sql/gv_tanda_registro_heredado_v2115.sql`.
